...
- Alert regression: **PARTIAL PASS** — 15m HEARTBEAT confirmed at bar close with matching KV state and no duplicate observed; event-specific transitions pending
